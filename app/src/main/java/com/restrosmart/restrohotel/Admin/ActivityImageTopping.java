...
import static com.restrosmart.restrohotel.ConstantVariables.TOPPING_IMAGE;
import static com.restrosmart.restrohotel.Utils.Sessionmanager.BRANCH_ID;
import static com.restrosmart.restrohotel.Utils.Sessionmanager.HOTEL_ID;

public class ActivityImageTopping  extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topping_gallery);
        init();
        setUpToolBar();
        ...
        mResultCallBack = new IResult() {
            ...
            public void notifySuccess(int requestId, Response<JsonObject> response) {
                ...
                try {
                    ...
                    JSONArray jsonArray = object.getJSONArray("toppingimages");
    ...
    private void getImage(final ArrayList<ImageForm> arrayListImage) {
        ...
        RVVImageAdapter adapter = new RVVImageAdapter(this, arrayListImage, mImageName, new PositionListener() {
            ...
            public void positionListern(int position) {
                Toast.makeText(ActivityImageTopping.this, "" + position, Toast.LENGTH_SHORT).show();
