...
public class ActivityAdminProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Sessionmanager sharedPreferanceManage = new Sessionmanager(ActivityAdminProfile.this);
        ...
        updatePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((selectedData == "null")) {
                    ...
                    Picasso.with(ActivityAdminProfile.this)
                            .load(empOldImage)
                            .resize(500, 500)
                            .into(mPhoto);
                ...
                mRetrofitService = new RetrofitService(mResultCallBack, ActivityAdminProfile.this);
            ...
            public void onClick(View view) {
                ...
                tvBranchStartTime.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        TimePickerDialog mTimePickerDialog = new TimePickerDialog(ActivityAdminProfile.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
    ...
    private void getAdapter(ArrayList<EmployeeForm> ArrayListEmployee) {
        for (int i = 0; i < ArrayListEmployee.size(); i++) {
            ...
            if (employeeId == empId) {
                ...
                Picasso.with(ActivityAdminProfile.this).load(empOldImage).resize(500, 500).into(mPhoto);
    ...
    private void initRetrofitCallback() {
        mResultCallBack = new IResult() {
                ...
                switch (requestId) {
                    ...
                    case EMP_EDIT_DETAILS:
                        ...
                        try {
                            ...
                            int status = jsonObject.getInt("status");
                            if (status == 1) {
                                Toast.makeText(ActivityAdminProfile.this, "Updated Successfully", Toast.LENGTH_LONG).show();
                                tvVisible();
                                etvInVisible();
                                getEmployeeList();

                            } else {
                                Toast.makeText(ActivityAdminProfile.this, "Try Again..", Toast.LENGTH_LONG).show();
                    ...
                    case UPDATE_EMP_IMAGE:
                        try {
                            ...
                            int status = jsonObject.getInt("status");
                            if (status == 1) {
                                Toast.makeText(ActivityAdminProfile.this, "Photo Updated Successfully", Toast.LENGTH_LONG).show();
            ...
            public void notifyError(int requestId, Throwable error) {
               ...
               // Toast.makeText(ActivityAdminProfile.this, "" + error, Toast.LENGTH_LONG).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (file_size <= 1024) {
                ...
                Toast.makeText(ActivityAdminProfile.this, "upload image should be 1mb", Toast.LENGTH_SHORT).show();
            }
        }
    }
