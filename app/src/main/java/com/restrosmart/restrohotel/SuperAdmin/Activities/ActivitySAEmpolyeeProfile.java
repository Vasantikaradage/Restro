...
public class ActivitySAEmpolyeeProfile extends AppCompatActivity {
    ...
    private void retrofitCallBack() {
        ...
        mRetrofitService = new RetrofitService(mResultCallBack, ActivitySAEmpolyeeProfile.this);
        mRetrofitService.retrofitData(GET_SA_ALL_EMPLOYEE, (service.getallEmployees(hotelId)));
    }
    ...
    private void getAdapter(ArrayList<EmployeeSAForm> employeeDetails) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.edit_employee) {
            /*Intent intent = new Intent(ActivitySAEmpolyeeProfile.this, ActivityAddAdmin.class);
