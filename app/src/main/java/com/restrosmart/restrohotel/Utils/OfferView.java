...
import  com.restrosmart.restrohotel.Utils.OfferDpPx;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
         ...
         //   mCornerType = typedArray.getInt(R.styleable.CustomTicketView_cornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CustomOfferView_cornerRadius, Utils.OfferDpPx(4f, getContext()));
          *//*  float elevation = 0f;
...
*//*
    ...
    protected void onDraw(Canvas canvas) {
        ...
        cv.drawCircle(w / 2, 1, 20, eraser);
        canvas.drawBitmap(bm, 0, 0, null);
        super.onDraw(canvas);
    }*/
    public static final String TAG = OfferView.class.getSimpleName();
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = typedArray.getInt(R.styleable.CustomTicketView_orientation, Orientation.HORIZONTAL);
            mBackgroundColor = typedArray.getColor(R.styleable.CustomTicketView_offerBackgroundColor, getResources().getColor((R.color.colorPrimary)));
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_scallopRadius,OfferDpPx.OfferDpPx(20f, getContext()));
            mScallopPositionPercent = typedArray.getFloat(R.styleable.CustomTicketView_scallopPositionPercent, 50);
            mShowBorder = typedArray.getBoolean(R.styleable.CustomTicketView_showBorder, false);
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_borderWidth, OfferDpPx.OfferDpPx(2f, getContext()));
            mBorderColor = typedArray.getColor(R.styleable.CustomTicketView_borderColor, getResources().getColor(android.R.color.black));
            mShowDivider = typedArray.getBoolean(R.styleable.CustomTicketView_showDivider, false);
            mDividerType = typedArray.getInt(R.styleable.CustomTicketView_dividerType, DividerType.NORMAL);
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_dividerWidth, OfferDpPx.OfferDpPx(2f, getContext()));
            mDividerColor = typedArray.getColor(R.styleable.CustomTicketView_dividerColor, getResources().getColor(android.R.color.darker_gray));
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_dividerDashLength, OfferDpPx.OfferDpPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_dividerDashGap, OfferDpPx.OfferDpPx(4f, getContext()));
            mCornerType = typedArray.getInt(R.styleable.CustomTicketView_cornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CustomTicketView_cornerRadius, OfferDpPx.OfferDpPx(4f, getContext()));
            float elevation = 5f;
            if (typedArray.hasValue(R.styleable.CustomTicketView_ticketElevation)) {
                elevation = typedArray.getDimension(R.styleable.CustomTicketView_ticketElevation, elevation);
            } else if (typedArray.hasValue(R.styleable.CustomTicketView_android_elevation)) {
    ...
    private void setShadowBlurRadius(float elevation) {
        ...
        float maxElevation = OfferDpPx.OfferDpPx(24f, getContext());
