...
class AdapterMenuPastOrder extends RecyclerView.Adapter<AdapterMenuPastOrder.MyHolder>{

    private Context context;
    private ArrayList<MenuForm> arrayListMenu;

    public AdapterMenuPastOrder(Context context, ArrayList<MenuForm> arrayList) {
    ...
    @NonNull
    @Override
    public AdapterMenuPastOrder.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fragment_past_order_recycler, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterMenuPastOrder.MyHolder myHolder, int i) {
