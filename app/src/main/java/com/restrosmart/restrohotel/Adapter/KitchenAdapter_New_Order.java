...
public class KitchenAdapter_New_Order extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public KitchenAdapter_New_Order(Context context, ArrayList<OrderModel> arrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            ...
            View itemView2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.kitchen_new_oder_footer, parent, false);
