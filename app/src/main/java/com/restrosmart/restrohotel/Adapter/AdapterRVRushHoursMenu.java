...
public class AdapterRVRushHoursMenu extends RecyclerView.Adapter<AdapterRVRushHoursMenu.ItemViewHolder> {
    private Context mContext;
    private ArrayList<OfferMenuForm> offerMenuFormArrayList;

    public AdapterRVRushHoursMenu(Context applicationContext, ArrayList<OfferMenuForm> offerMenuForms) {
    ...
    @NonNull
    @Override
    public AdapterRVRushHoursMenu.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView;
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRVRushHoursMenu.ItemViewHolder itemViewHolder, int i) {
