...
public class Kitchen_Past_Details extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            ...
            View itemView2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_kitchen_oder_footer, parent, false);
