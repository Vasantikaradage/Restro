...
public class RVTableOrderAdapter extends RecyclerView.Adapter<RVTableOrderAdapter.ViewHolder> {
    ...
    public RVTableOrderAdapter(Context context, int hotelId, ArrayList<AllOrderModel> allOrderModelArrayList, ArrayList<UserCategory> userCategoryArrayList, CapOrderDeleteListener capOrderDeleteListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RVTableOrderAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.tvTableId.setText(String.valueOf(allOrderModel.getTableNo()));
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("title", "Table Order");
