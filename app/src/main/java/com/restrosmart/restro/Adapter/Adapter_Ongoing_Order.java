...
import com.restrosmart.restro.Admin.OnGoingViewDetails;
...
public class Adapter_Ongoing_Order extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            ...
            View itemView2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_ongoing_oder_footer, parent, false);
       ...
       TextView suggestion;
        ...
        public FooterViewHolder(View itemView1) {
          ...
          suggestion = (TextView)itemView1.findViewById(R.id.suggestion);
            ...
            mView = (ImageButton) itemView1.findViewById(R.id.btn_new_order);
